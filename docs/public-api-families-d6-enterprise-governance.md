...
- `axp-spec/schemas/public_api/*.json` (canonical schema contracts; current repository path remains `axp-spec` during transition)
- `axp-spec/docs/public-api-schema-index.md` (schema-to-operation mapping; current repository path remains `axp-spec` during transition)
...
- `axp-spec/schemas/public_api/` (current repository path remains `axp-spec` during transition)
- `axp-spec/docs/public-api-schema-index.md` (authoritative mapping by operation; current repository path remains `axp-spec` during transition)
